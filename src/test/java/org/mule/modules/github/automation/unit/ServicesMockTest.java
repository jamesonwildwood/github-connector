 ...
 */
package org.mule.modules.github.automation.unit;
...
import org.mule.modules.github.service.ExtendedRepositoryService;
...
public class ServicesMockTest {
    ...
    private GitHubConnector gitHubModule;
    @Mock
    private Team team1;
    @Mock
    private Team team2;
    ...
    public void setUpTests() throws Exception {
        ...
        gitHubModule = new GitHubConnector();
        gitHubModule.getConfig().setServiceFactory(serviceFactory);
    }
    ...
    public void closeIssue() throws Exception {
        GitHubConnector gitHubModuleSpy = spy(gitHubModule);
    ...
    public void getFileContent() throws TransformerException, IOException {
        final String fileContent = "Thisissomefile";
        final Blob content = new Blob();
        content.setContent(new Base64Encoder().doTransform(fileContent, "utf-8").toString());
        content.setEncoding("utf-8");
        when(repositoryService.getContents(eq(new RepositoryId(USER, REPOSITORY)), eq("somepath"), eq("master"))).thenReturn(content);
        assertEquals(fileContent, gitHubModule.getFileContent(USER, REPOSITORY, "somepath", "master"));
    }
