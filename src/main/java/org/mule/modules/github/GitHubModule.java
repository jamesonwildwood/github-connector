 ...
 * @author MuleSoft, Inc.
 */
@Connector(name = "github", schemaVersion = "1.0", friendlyName = "GitHub", minMuleVersion = "3.4")
public class GitHubModule {
    ...
    public String getFileContent(final String owner, final String repositoryName,
        ...
        final Blob contents = getServiceFactory().getRepositoryService().
                getContents(RepositoryId.create(owner, repositoryName), URLEncoder.encode(path, "UTF-8"), branch);
